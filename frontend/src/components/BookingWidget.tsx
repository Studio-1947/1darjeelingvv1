    ...
    <form onSubmit={submit} data-testid="booking-widget" className="relative w-full">
      <div ref={containerRef} className="relative w-full max-w-4xl mx-auto">
        ...
        <div className="hidden md:block">
          ...
          <div className="relative z-20 flex items-stretch bg-black/60 backdrop-blur-xl border border-white/20 rounded-2xl shadow-[0_16px_40px_-12px_rgba(0,0,0,0.8)] p-2 transition-all hover:border-white/30">
