...
export const SEED_LISTINGS: SeedListing[] = [
    ...
    { title: "Teesta Rangeet Tourism Festival", type: "event", description: "Cultural showcase of the hills — folk dance, adventure and food.", location: "Darjeeling & Sikkim", price: 0, image: "https://res.cloudinary.com/drgb8w8ak/image/upload/v1784112327/teestafestival_l8fpyq.webp", tags: ["cultural", "adventure"], extras: { month: "December" } },
