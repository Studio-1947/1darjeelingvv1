...
export const SEED_LISTINGS: SeedListing[] = [
    ...
    { title: "Gorkhey Haat", type: "shop", description: "Weekly open-air Gorkha haat — momos, sel roti, sekuwa, crafts and organic produce.", location: "Chauk Bazar, Darjeeling", price: 100, image: "https://miro.medium.com/v2/resize:fit:1100/format:webp/1*3FXYRuN6fc-JOVbhIDrJ2g.jpeg", tags: ["haat", "street-food", "gorkha", "organic"], extras: { amenities: ["Culinary Offerings", "Organic Products", "Traditional Food", "Cultural Artifacts", "Beverages"], no_reserve: true } },
